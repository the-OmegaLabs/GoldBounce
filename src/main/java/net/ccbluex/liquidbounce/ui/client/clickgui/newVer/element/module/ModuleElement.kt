...
class ModuleElement(val module: Module): MinecraftInstance() {
    ...
    fun drawElement(mouseX: Int, mouseY: Int, x: Float, y: Float, width: Float, height: Float, accentColor: Color): Float {
        ...
        Fonts.font24.drawString(module.description, x + 20F, y + height / 2F + 4F, 10526880L.toInt())
        ...
        if (MouseUtils.mouseWithinBounds(mouseX, mouseY, 
                ...
                x + 35F + Fonts.font40.getStringWidth(module.name) + Fonts.font24.getStringWidth(keyName),
                y + height / 2F))
        ...
        Fonts.font24.drawString(keyName, x + 30.5F + Fonts.font40.getStringWidth(module.name), y + height / 2F - Fonts.font40.FONT_HEIGHT + 5.5F, -1)
