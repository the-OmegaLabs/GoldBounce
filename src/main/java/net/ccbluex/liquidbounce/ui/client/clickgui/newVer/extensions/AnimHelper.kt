...
fun Float.animSmooth(target: Float, speed: Float) = if (NewGUI.fastRenderValue.get()) target else AnimationUtils水影加加.animate(target, this, speed * RenderUtils.deltaTime * 0.025F)
