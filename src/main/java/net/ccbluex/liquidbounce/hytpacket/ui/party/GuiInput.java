...
import net.ccbluex.liquidbounce.hytpacket.ui.ClickableButton;
import net.ccbluex.liquidbounce.hytpacket.ui.InputField;
...
public class GuiInput extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtils.INSTANCE.drawImage(new ResourceLocation("hyt/background.png"), width / 2 - 100, height / 2 - 81, 200, 162);
