...
/* compiled from: IClickEvent.kt */
@Metadata(mv = {1, 1, 16}, bv = {1, 0, 3}, k = 1, d1 = {"��\f\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\bf\u0018��2\u00020\u0001:\u0001\u0002¨\u0006\u0003"}, d2 = {"Lnet/ccbluex/liquidbounce/api/minecraft/event/IClickEvent;", "", "WAction", "Pride"})
/* loaded from: Ordinary２－９ｃｒｋ.jar:net/ccbluex/liquidbounce/api/minecraft/event/IClickEvent.class */
public interface IClickEvent {
    ...
    /* loaded from: Ordinary２－９ｃｒｋ.jar:net/ccbluex/liquidbounce/api/minecraft/event/IClickEvent$WAction.class */ enum WAction {
        OPEN_URL
    }
}
