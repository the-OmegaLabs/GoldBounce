...
/* compiled from: ICPacketEntityAction.kt */
...
/* loaded from: Ordinary２－９ｃｒｋ.jar:net/ccbluex/liquidbounce/api/minecraft/network/play/client/ICPacketEntityAction.class */
public interface ICPacketEntityAction extends IPacket {
    ...
    /* loaded from: Ordinary２－９ｃｒｋ.jar:net/ccbluex/liquidbounce/api/minecraft/network/play/client/ICPacketEntityAction$WAction.class */ enum WAction {
        START_SNEAKING,
        STOP_SNEAKING,
        STOP_SLEEPING,
        START_SPRINTING,
