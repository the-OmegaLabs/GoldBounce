...
/* compiled from: WEnumPlayerModelParts.kt */
...
/* loaded from: Ordinary２－９ｃｒｋ.jar:net/ccbluex/liquidbounce/api/minecraft/client/entity/player/WEnumPlayerModelParts.class */
public enum WEnumPlayerModelParts {
    CAPE,
    JACKET,
    LEFT_SLEEVE,
    RIGHT_SLEEVE,
