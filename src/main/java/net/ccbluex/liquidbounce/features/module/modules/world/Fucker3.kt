...
import net.ccbluex.liquidbounce.utils.skid.xinxin.BlockUtil.isFullBlock
...
object Fucker3 : Module(name = "Fucker3", Category.WORLD) {
    ...
    private val rotationOptions = RotationSettings(this)
    private val surroundingsValue = BoolValue("Surroundings", true)
    val noHitValue = BoolValue("NoAura", false)
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        if (rotationsValue.get())
            RotationUtils.setTargetRotation(rotations.rotation,rotationOptions)
